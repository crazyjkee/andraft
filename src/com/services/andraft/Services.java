...
public class Services extends Service {
	...
	protected void requestLocationUpdates() {
		...
		locationUpdateRequester.requestPassiveLocationUpdates(
				GeoConstants.PASSIVE_MAX_TIME,
				GeoConstants.PASSIVE_MAX_DISTANCE,
		...
		String bestAvailableProvider = locationManager.getBestProvider(
				criteria, true);
		Log.d("myLogs", "bestProvider=" + bestProvider
	...
	protected BroadcastReceiver locPassiveReceiver = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (intent.getAction().equals(GeoConstants.PASSIVE_LOCATION_UPDATE)) {
				...
				Log.d("myLogs", "Passive location11:" + location.getLongitude());
				updateWithNewLocation(location);
